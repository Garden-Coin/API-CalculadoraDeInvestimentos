...
describe('normalizarRentabilidadeMensal', () => {
	describe('Anual Profitability', () => {
		it.each(profitabilityTestCaseArray)('should divide profitability of %s by 12.68', (profitability) => {
		...
		it.each(periodTestCaseArray)('should multiply period of %s by 12', (period) => {
